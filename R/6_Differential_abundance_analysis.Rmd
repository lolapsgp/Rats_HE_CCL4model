...
metadata1<-subset(metadata, select = c(SampleID, Group, Batch))
...
boxplot.mvabund(obj)
meanvar.plot(obj)
glm <-manyglm(obj~(metadata$Group)|Batch, family="negative.binomial")
...
glm2 <-manyglm(obj~(metadata1$Group)|metadata1$Batch, family="negative.binomial")
