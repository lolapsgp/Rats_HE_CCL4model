...
head(asvmat)
write.csv(asvmat, "/fast/AG_Forslund/Lola/CIPF_2018/Analysis/output/Tables/otu_table.csv", row.names = F, col.names = F)
...
write.csv(taxa, "/fast/AG_Forslund/Lola/CIPF_2018/Analysis/output/Tables/tax_table.csv", row.names = F, col.names = F)
